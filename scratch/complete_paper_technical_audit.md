...
**Audit Method:** Automated Codebase & Artifact Scanning (Zero Hallucination / Fact-Based Verification)
...
- **Problem Statement:** Standard object detection benchmarks (COCO) fail to account for severe class imbalance, extreme occlusion, varied lighting, and regional vehicle types (e.g., auto-rickshaws, high rider density) in smart-city traffic monitoring.
- **End-to-End Workflow:**
  1. **Dataset Pipeline:** BDD100K raw annotations -> BDD-to-YOLO conversion (`src/bdd_to_yolo_prod.py`) -> Curation & Validation (`src/verify_dataset.py`) -> Class Balancing via Rider Oversampling (`src/oversample_rider.py`) -> Multi-Dataset Fusion with IDD & Auto-Rickshaws (`src/merge_idd.py`, `src/merge_auto_yolo.py`).
  2. **Model Training Pipeline:** Unified dispatch orchestrator (`scripts/train_all_models.py`) supporting YOLOv5, YOLOv7, and YOLOv8 models.
  3. **Evaluation & Benchmarking Pipeline:** Automated evaluation (`scripts/evaluate_models.py`), FPS/latency benchmarking (`scripts/benchmark.py`), figure generation (`scripts/generate_figures.py`), and table formatting (`scripts/generate_tables.py`).
...
- **Data Balancing / Oversampling:** Implemented in `src/oversample_rider.py` by duplicating images containing vulnerable road users (`rider`, `motorcycle`, `bicycle`), expanding `rider` instances to `86,927` and `motorcycle` instances to `91,711` (total bounding boxes: `638,286`).
- **Data Cleaning:** Verified by `src/verify_dataset.py`. Result: Missing labels = `0`, Empty images = `0`, Corrupted images = `0` (Source: `dataset_statistics/dataset_statistics.json`).
...
## 4. Training Configuration (All 17 Completed Runs)
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- |
| `train_yolov5m` | `yolov5m.pt` | 50 | 16 | Unknown | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train_yolov5s_v1` | `last.pt` | 50 | 16 | Unknown | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `validation_yolov5s` | `yolov5s.pt` | 1 | 16 | Unknown | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `object_stage1` | `yolov8l.pt` | 30 | 8 | 832 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `object_stage2` | `best.pt` | 70 | 8 | 832 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `object_stage3_strong2` | `best.pt` | 50 | 6 | 960 | `auto` | 0.005 | Linear / Cosine | 0.0007 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `object_stage4_riderfix4` | `best.pt` | 50 | 6 | 960 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train3` | `yolov8n.pt` | 10 | 16 | 640 | `auto` | 0.01 | Linear (default) | 0.0005 | `cpu` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train4` | `yolov8n.pt` | 1 | 16 | 640 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train5` | `yolov8n.pt` | 2 | 16 | 640 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train6` | `yolov8l.pt` | 50 | 8 | 832 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train_auto_v1` | `yolov8l.pt` | 50 | 4 | 640 | `auto` | 0.01 | Linear (default) | 0.0005 | `None` | True | 8 | 0 | CUDA GPU (Device 0) |
| `train_fast2` | `best.pt` | 30 | 32 | 512 | `auto` | 0.01 | Linear (default) | 0.0005 | `0` | True | 2 | 0 | CUDA GPU (Device 0) |
| `train_yolov8m` | `last.pt` | 50 | 8 | 640 | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 42 | CUDA GPU (Device 0) |
| `train_yolov8n` | `yolov8n.pt` | 50 | 16 | 640 | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 42 | CUDA GPU (Device 0) |
| `train_yolov8n2` | `yolov8n.pt` | 50 | 16 | 640 | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 42 | CUDA GPU (Device 0) |
| `train_yolov8s2` | `last.pt` | 50 | 16 | 640 | `SGD` | 0.01 | Linear (default) | 0.0005 | `0` | True | 8 | 42 | CUDA GPU (Device 0) |

---

## 5. Training Results (All Completed Runs)
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :--- | :--- |
| `train_yolov5m` | N/A | N/A | N/A | N/A | 50 | 50 | `0.055404/0.016665` | `0.054014/0.037337` | [`experiments\yolov5\train_yolov5m\weights\best.pt`](file:///c:\Repo\object-Detection\experiments\yolov5\train_yolov5m\weights\best.pt) | [`experiments\yolov5\train_yolov5m\results.csv`](file:///c:\Repo\object-Detection\experiments\yolov5\train_yolov5m\results.csv) |
| `train_yolov5s_v1` | N/A | N/A | N/A | N/A | 50 | 50 | `0.062517/0.019894` | `0.060385/0.012526` | [`experiments\yolov5\train_yolov5s_v1\weights\best.pt`](file:///c:\Repo\object-Detection\experiments\yolov5\train_yolov5s_v1\weights\best.pt) | [`experiments\yolov5\train_yolov5s_v1\results.csv`](file:///c:\Repo\object-Detection\experiments\yolov5\train_yolov5s_v1\results.csv) |
| `validation_yolov5s` | N/A | N/A | N/A | N/A | 1 | 1 | `0.085889/0.042542` | `0.071426/0.024444` | [`experiments\yolov5\validation_yolov5s\weights\best.pt`](file:///c:\Repo\object-Detection\experiments\yolov5\validation_yolov5s\weights\best.pt) | [`experiments\yolov5\validation_yolov5s\results.csv`](file:///c:\Repo\object-Detection\experiments\yolov5\validation_yolov5s\results.csv) |
| `object_stage1` | 0.6443 | 0.4012 | 0.4106 | 0.2256 | 30 | 30 | `1.16936/0.59108` | `1.37319/0.81717` | [`runs\detect\object_stage1\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\object_stage1\weights\best.pt) | [`runs\detect\object_stage1\results.csv`](file:///c:\Repo\object-Detection\runs\detect\object_stage1\results.csv) |
| `object_stage2` | 0.5058 | 0.3834 | 0.3901 | 0.2121 | 70 | 70 | `0.85839/0.4022` | `1.44274/0.87789` | [`runs\detect\object_stage2\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\object_stage2\weights\best.pt) | [`runs\detect\object_stage2\results.csv`](file:///c:\Repo\object-Detection\runs\detect\object_stage2\results.csv) |
| `object_stage3_strong2` | 0.6116 | 0.4538 | 0.4732 | 0.2552 | 50 | 50 | `0.98805/0.45017` | `1.49319/0.90751` | [`runs\detect\object_stage3_strong2\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\object_stage3_strong2\weights\best.pt) | [`runs\detect\object_stage3_strong2\results.csv`](file:///c:\Repo\object-Detection\runs\detect\object_stage3_strong2\results.csv) |
| `object_stage4_riderfix4` | 0.5998 | 0.4463 | 0.4617 | 0.2572 | 50 | 50 | `0.65546/0.31766` | `1.48271/0.95624` | [`runs\detect\object_stage4_riderfix4\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\object_stage4_riderfix4\weights\best.pt) | [`runs\detect\object_stage4_riderfix4\results.csv`](file:///c:\Repo\object-Detection\runs\detect\object_stage4_riderfix4\results.csv) |
| `train3` | 0.4049 | 0.0019 | 0.2034 | 0.1220 | 10 | 10 | `0.47044/1.0977` | `1.86219/6.89667` | [`runs\detect\train3\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train3\weights\best.pt) | [`runs\detect\train3\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train3\results.csv) |
| `train4` | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 1 | 1 | `1.00083/27.0206` | `2.06387/6.33946` | [`runs\detect\train4\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train4\weights\best.pt) | [`runs\detect\train4\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train4\results.csv) |
| `train5` | 0.5697 | 0.1809 | 0.1601 | 0.0890 | 2 | 2 | `1.71652/1.57438` | `1.63892/1.45869` | [`runs\detect\train5\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train5\weights\best.pt) | [`runs\detect\train5\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train5\results.csv) |
| `train6` | 0.6526 | 0.3983 | 0.4086 | 0.2244 | 50 | 50 | `1.04538/0.49609` | `1.40394/0.82747` | [`runs\detect\train6\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train6\weights\best.pt) | [`runs\detect\train6\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train6\results.csv) |
| `train_auto_v1` | 0.5554 | 0.4742 | 0.4828 | 0.2952 | 50 | 50 | `1.04907/0.50591` | `1.36459/0.80363` | [`runs\detect\train_auto_v1\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_auto_v1\weights\best.pt) | [`runs\detect\train_auto_v1\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_auto_v1\results.csv) |
| `train_fast2` | 0.7147 | 0.5065 | 0.5524 | 0.3480 | 30 | 30 | `0.97265/0.52545` | `1.22743/0.69432` | [`runs\detect\train_fast2\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_fast2\weights\best.pt) | [`runs\detect\train_fast2\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_fast2\results.csv) |
| `train_yolov8m` | 0.6452 | 0.4503 | 0.4895 | 0.3277 | 50 | 50 | `0.99407/0.55768` | `1.23188/1.09781` | [`runs\detect\train_yolov8m\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8m\weights\best.pt) | [`runs\detect\train_yolov8m\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8m\results.csv) |
| `train_yolov8n` | 0.5811 | 0.3605 | 0.3927 | 0.2555 | 50 | 50 | `1.19413/0.78194` | `1.37789/1.16059` | [`runs\detect\train_yolov8n\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8n\weights\best.pt) | [`runs\detect\train_yolov8n\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8n\results.csv) |
| `train_yolov8n2` | 0.5811 | 0.3605 | 0.3927 | 0.2555 | 50 | 50 | `1.19413/0.78194` | `1.37789/1.16059` | [`runs\detect\train_yolov8n2\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8n2\weights\best.pt) | [`runs\detect\train_yolov8n2\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8n2\results.csv) |
| `train_yolov8s2` | 0.6285 | 0.4178 | 0.4599 | 0.3010 | 50 | 50 | `1.0749/0.64406` | `1.28329/1.10255` | [`runs\detect\train_yolov8s2\weights\best.pt`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8s2\weights\best.pt) | [`runs\detect\train_yolov8s2\results.csv`](file:///c:\Repo\object-Detection\runs\detect\train_yolov8s2\results.csv) |
...
- **Python Version:** Python 3.11.9 (tags/v3.11.9:de54cf5)
- **PyTorch Version:** PyTorch 2.11.0 (with CPU & GPU execution support)
